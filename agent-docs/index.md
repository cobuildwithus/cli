...
| `agent-docs/references/testing-ci-map.md`      | Verification, CI, and release enforcement map (including release verify/docs gates and pnpm setup behavior). | `package.json`, `.github/workflows/test-and-coverage.yml`, `.github/workflows/release.yml`, scripts | CLI Maintainer | Per CI/process change        | Medium      | 2026-02-25    |
