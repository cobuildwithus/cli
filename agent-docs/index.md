...
| `agent-docs/references/testing-ci-map.md`      | Verification, CI, and release enforcement map (including release verify/docs gates, pnpm setup behavior, and docs-drift release artifact policy). | `package.json`, `.github/workflows/test-and-coverage.yml`, `.github/workflows/release.yml`, scripts | CLI Maintainer | Per CI/process change        | Medium      | 2026-02-25    |
