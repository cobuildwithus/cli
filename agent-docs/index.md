...
| `agent-docs/references/testing-ci-map.md`      | Verification and CI/local enforcement map.                            | `package.json`, `.github/workflows/test-and-coverage.yml`, `.github/workflows/release.yml`, scripts | Build Bot Maintainer | Per CI/process change        | Medium      | 2026-02-25    |
